...
<!-- Mirrored from demo.voidcoders.com/htmldemo/maxtreo/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jul 2023 12:32:19 GMT -->
<head>
<meta charset="UTF-8">
...
<div class="pgs-box">
<a href="rtl/contact.html">View RTL Verson</a>
</div>
</div>
...
<input type="text" class="form-control m-input" name="name" id="name" placeholder="Your Name *" onfocus="this.placeholder = ''" onblur="this.placeholder ='Your Name *'">
</div>
<div class="form-group mcfg">
<input type="text" class="form-control m-input" name="email" id="email" placeholder="Your Email *" onfocus="this.placeholder = ''" onblur="this.placeholder ='Your Email *'">
</div>
<div class="form-group mcfg">
<textarea rows="4" class="form-control m-input" name="msg" id="msg" placeholder="Message *" onfocus="this.placeholder =''" onblur="this.placeholder ='Message *'"></textarea>
</div>
...
<div class="single-info">
<h5>Email:</h5>
<p><a href="https://demo.voidcoders.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="8eefe3efe7e2cee3ebf6fafcebe1a0ede1e3">npdhevents1980@gmail.com</a></p>
<p><a href="https://demo.voidcoders.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="274942504a464e4b674a425f535542480944484a">npdhevents1980@gmail.com</a></p>
</div>
</div>
</div>
</div>
...
<!-- Mirrored from demo.voidcoders.com/htmldemo/maxtreo/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jul 2023 12:32:20 GMT -->
</html>