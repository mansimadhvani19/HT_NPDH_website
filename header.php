<header class="mextreo-header-area mha-inner main-header">
    <style>
        .logo-wrapper img {
    ...
    <div class="container c-fulid-max outer-container">
        <div class="row header-upper clearfix">
            <div class="col-4 col-md-4 outer-box pull-left">
                <div class="logo-wrapper logo-box pull-left">
                    <a href="index.php">
